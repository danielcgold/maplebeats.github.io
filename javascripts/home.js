...
chenghai(document).ready(function(){
		...
		chenghai("#kgmb").click(function(){
				...
				closeNotice();
				chenghai("#getmenu").css("display", "none");
				lebaobaoSay("你的阴谋已经被我识破了!居然想把我拐走,饭团救命啊");
				setFace(3);
				setTimeout(function(){
...
var path = "http://maplebeats.com/";var imagewidth = '110';var imageheight = '152';
createFace("/images/1.png", "/images/2.png", "/images/3.png", "/images/4.png");
